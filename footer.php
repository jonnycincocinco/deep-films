	<!--footer class="site-footer anim-in-out anim-slide-below-fade below-hero" data-anim-speed="2000">
		<div class="container">
			<div class="grid">
				<div class="grid__item">
					<span class="site-footer-brand__ident">Deepfilms</span>
				</div>
				<div class="grid__item">
		...
		<div class="container">
			<div class="grid">
				...
				<div class="grid__item legal">
					<p>Deepfilms is a Public Benefit Corporation and is an SEC registered investment advisor.  Brokerage services are provided by Robinhood Financial, LLC.</p>
